            ...
            <div className="container mx-auto flex h-16 md:h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <Link href="/" className="flex items-center gap-2">
                    <span className="text-lg md:text-2xl font-bold text-slate-800 tracking-tight">
                        Cout-Isolation-Maison<span className="text-teal-600">.fr</span>
                    </span>
                </Link>
                    ...
                    <nav className="container mx-auto px-4 py-4 space-y-2">
                        {navLinks.map((link) => (
                            <Link
                                key={link.href}
                                href={link.href}
                                className="flex items-center gap-3 p-3 text-slate-700 hover:bg-teal-50 hover:text-teal-600 rounded-lg font-medium transition-colors"
